...
<body>
    <div class="container">
        ...
        $tablename = $name." ".$pos;
        echo '
        <form action="./_candidates.php?org_name='.$tablename.'&p_no='.$p_no.'" method="post" enctype="multipart/form-data">';
        for($i=0; $i<$p_no; $i++)
        {
                    echo '
                        ...
                        <div class="input-group mb-3">
                            ...
                            <input  name = "file-'.$i.'" type="file" class="form-control" id="inputGroupFile02">
                        </div>';
        }
                    echo '
                        <div >
